...
class IndexScan : public Iterator
{
    ...
    public:
        ...
        void setIterator()
        {
            setIterator(NULL, NULL, true, true);
        }
...
class Project : public Iterator {
    ...
    private:
        ...
        void join(map<string, AttributeData>, void *);
};
...
class INLJoin : public Iterator {
    ...
    private:
        ...
        void setupResultCache();
        void join(void *data, const map<string, AttributeData> &fields);
};
