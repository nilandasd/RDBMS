...
private:
  ...
  // Convert tableName and attrName to Index file name
  ...
  RC getIndexFiles(const string &tableName, vector<IndexFile> &indexFiles);

  RC insertIndex(const string &, const string &);

  void prepareIndexRecordData(const string &, const string &, void *);
